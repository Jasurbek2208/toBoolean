...
toBoolean(0)//false
toBoolean(1)//true
*@see{@link https://github.com/Jasurbek2208/toBoolean}*/export const toBoolean=(t:boolean|string|number|Object|null|undefined):boolean=>(t&&typeof t=='object')?(Array.isArray(t)?t?.length>0:Object.keys(t)?.length>0):typeof t!='string'?!!t:t?.trim()?.toLowerCase()=='true'